		...
		var t = {
				...
				853: function (t, e, i) {
						...
						return (
							...
							p
								...
								: Object.assign(
										{},
										T,
										(((e = {})[D] = E ? _ + "px" : ""), (e[x] = k ? m + "px" : ""), (e.transform = ""), e)
								  )
						);
					}
					var it = {
							...
							: ft(
									(function (t) {
										var e,
											...
											d = -n.scrollTop;
										return (
											"rtl" === W(r || i).direction && (s += H(i.clientWidth, r ? r.clientWidth : 0) - o),
												...
												M(i) === s
													? (function (t, e) {
															...
															var f = p.reduce(function (e, i) {
																return (
																	(e[i] = mt(t, { placement: i, boundary: r, rootBoundary: o, padding: a })[M(i)]), e
																);
															}, {});
					...
					function Ot(t, e, i) {
						...
						return (
							(o || (!o && !i)) &&
								(("body" !== L(e) || ut(s)) &&
									(c = (n = e) !== I(n) && C(n) ? { scrollLeft: (r = n).scrollLeft, scrollTop: r.scrollTop } : ct(n)),
				...
				554: function (t, e) {
					...
					function rt(t) {
						"none" !== t.style.display &&
							(t.style.display && (t.dataset.styleDisplay = t.style.display), (t.style.display = "none"));
					}
					function ot(t) {
						"none" === t.style.display &&
					...
					function ft(t, e) {
						...
						if (
							n.language &&
							(n.language !== d &&
								(o[n.language] ? (i = n.language) : void 0 === o[(i = n.language.split("-")[0])] && (i = !1)),
							delete n.language,
							i)
						) {
							d = r.language = i;
						...
						if (
							(n.daysOfWeekDisabled &&
								((r.daysOfWeekDisabled = n.daysOfWeekDisabled.reduce(lt, [])), delete n.daysOfWeekDisabled),
							n.daysOfWeekHighlighted &&
								((r.daysOfWeekHighlighted = n.daysOfWeekHighlighted.reduce(lt, [])), delete n.daysOfWeekHighlighted),
											...
											Array.from(this.grid.children).forEach(function (e, i) {
												...
												if (
													...
													r > d &&
														...
														r === d &&
															(n.add("range-start", "bg-gray-100", "dark:bg-gray-600", "rounded-l-lg"),
															n.remove("rounded-lg", "rounded-r-lg")),
														r === c &&
															(n.add("range-end", "bg-gray-100", "dark:bg-gray-600", "rounded-r-lg"),
											...
											this.grid
												...
												Array.from(this.grid.children).forEach(function (e) {
													...
													o.remove("bg-gray-200", "dark:bg-gray-600", "rounded-l-lg", "rounded-r-lg"),
														r > i &&
															r < n &&
															(o.add("range", "bg-gray-200", "dark:bg-gray-600"), o.remove("rounded-lg")),
														r === i &&
															(o.add("range-start", "bg-gray-200", "dark:bg-gray-600", "rounded-l-lg"),
															o.remove("rounded-lg")),
														r === n &&
															(o.add("range-end", "bg-gray-200", "dark:bg-gray-600", "rounded-r-lg"),
															o.remove("rounded-lg")),
														t.selected.includes(r) &&
															(o.add(
																"selected",
										...
										if (
											(m(t, "minDate") &&
												(void 0 === t.minDate
													...
													: ((this.minYear = H(t.minDate, this.step)), (this.minDate = I(this.minYear, 0, 1)))),
											m(t, "maxDate") &&
												(void 0 === t.maxDate
													? (this.maxYear = this.maxDate = void 0)
													: ((this.maxYear = H(t.maxDate, this.step)), (this.maxDate = I(this.maxYear, 11, 31)))),
								...
								},
								{
									...
									value: function () {
										...
										c === document.body
											...
											"auto" === E &&
												(e < 0 ? ((E = "left"), (e = 10)) : (E = e + u > v || "rtl" === zt(d) ? "right" : "left")),
											"right" === E && (e -= u - _),
					...
					function Qt(t, e, i) {
						...
						var a = $t(t, e, n);
						a &&
							(a.toString() !== t.dates.toString() ? ((t.dates = a), Gt(t, r ? 3 : 1), xt(t, "changeDate")) : Gt(t, 1),
							o && t.hide());
					}
					var Zt = (function () {
						return a(
				...
				673: function (t, e, i) {
							...
							return (
								...
								(t.prototype.destroy = function () {
									this._triggerEl &&
										this._targetEl &&
										this._initialized &&
										(this._triggerEl && this._triggerEl.removeEventListener("click", this._triggerElClickHandler),
										(this._initialized = !1));
								}),
								(t.prototype.removeInstance = function () {
					...
					(e.initCopyClipboards = d),
						"undefined" != typeof window && ((window.CopyClipboard = s), (window.initClipboards = d)),
						(e.default = s);
				},
				922: function (t, e, i) {
					var n =
							...
							return (
								...
								(t.prototype.show = function () {
									this._targetEl.classList.remove("hidden"),
										...
										this._popperInstance.setOptions(function (t) {
											return n(n({}, t), {
												modifiers: r(r([], t.modifiers, !0), [{ name: "eventListeners", enabled: !0 }], !1),
											});
										}),
								...
								(t.prototype.hide = function () {
									this._targetEl.classList.remove("block"),
										...
										this._popperInstance.setOptions(function (t) {
											return n(n({}, t), {
												modifiers: r(r([], t.modifiers, !0), [{ name: "eventListeners", enabled: !1 }], !1),
											});
										}),
										(this._visible = !1),
				...
				656: function (t, e, i) {
						...
						document.querySelectorAll("[data-input-counter]").forEach(function (t) {
							...
							t
								? r.default.instanceExists("InputCounter", t.getAttribute("id")) ||
								  new s(t, i || null, n || null, { minValue: o ? parseInt(o) : null, maxValue: a ? parseInt(a) : null })
								: console.error(
										'The target element with id "'.concat(
											e,
					...
					(e.initInputCounters = d),
						"undefined" != typeof window && ((window.InputCounter = s), (window.initInputCounters = d)),
						(e.default = s);
				},
				16: function (t, e, i) {
					var n =
					...
					var i = new ((function () {
						...
						return (
							...
							(t.prototype._componentAndInstanceCheck = function (t, e) {
								return this._instances[t]
									? !!this._instances[t][e] ||
											(console.warn("Flowbite: Instance with ID ".concat(e, " does not exist.")), !1)
									: (console.warn("Flowbite: Component ".concat(t, " does not exist.")), !1);
							}),
							t
						);
